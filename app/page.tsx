    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="text-xl font-bold">Customsnavigator AI Simplified</h1>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 max-w-3xl mx-auto">
          CustomsNavigator AI - Simplified Import/Export Compliance
        </h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-8">Join thousands of teams already using Customsnavigator AI Simplified.</p>
      ...
      <footer className="border-t py-8 text-center text-sm text-gray-500">
        <p>© {new Date().getFullYear()} Customsnavigator AI Simplified. Built by <a href="https://projectgreenbelt.com" className="underline">Greenbelt</a>.</p>
      </footer>
    </div>
  );
}
