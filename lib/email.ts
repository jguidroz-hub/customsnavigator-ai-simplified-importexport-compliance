...
const FROM = process.env.EMAIL_FROM || 'CustomsNavigator AI - Simplified Import/Export Compliance <noreply@example.com>';
const APP_NAME = 'CustomsNavigator AI - Simplified Import/Export Compliance';
